...
namespace Tools
{
    public class Assembly : Singleton<Assembly>
    {
        ...
        private const BindingFlags BINDING_FLAGS_PUBLIC =
            BindingFlags.Public | BindingFlags.Static | BindingFlags.Instance | BindingFlags.DeclaredOnly;

        private readonly Type[] _allTypes = System.Reflection.Assembly.GetExecutingAssembly().GetTypes();

        public T FindAndNullSafely<T, TAttribute>(T[] array, Predicate<TAttribute> match)
            where T : MemberInfo where TAttribute : Attribute
        {
